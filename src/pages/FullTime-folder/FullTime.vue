    ...
    <div class="row q-px-xl">
      <div class="col-10" style="align-self: center;">
        <div class="row">
          ...
          <q-select v-model="formData.year" :options="selectYear" class=" q-ml-sm" label="Year" filled dense clearable
          ...
          <div class="q-px-sm row">
            <div class="col-6">
              <q-select v-model="formData.block" :options="filteredBlock" class=" q-pr-sm" label="Block" filled dense
                clearable style="min-width: 140px;" option-value="id" option-label="name">
              </q-select>
            </div>
        ...
        <q-form @submit="submitForm" style=" height: 450px;" class="q-py-lg">
          <div class="row">
            ...
            <div class="col-3 q-pr-sm">
              <q-input readonly v-model="formData.school_year" :options="schoolYearOptions" label="School Yr"
                outlined />
            ...
            <div class="col-2 q-pl-md q-pr-sm ">
              <q-input class="q-mb-md" v-model="formData.block.name" readonly label="Block" outlined />
            </div>
