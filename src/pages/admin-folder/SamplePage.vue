  ...
  <q-layout view="hHh Lpr lff" container style="height: 100vh">
            ...
            <div class="row no-wrap flex">
              <div class="column">
                ...
                <div class="profile-info q-pa-sm">
                  ...
                  <q-list>
                    <q-item clickable v-ripple to="/admin/accountmanagement" class="it-1">
    ...
    <q-drawer class="q-pt-lg" v-model="drawer" show-if-above :mini="!drawer || miniState" @click.capture="drawerClick"
      ...
      <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }">
        <q-list padding>
          <q-item clickable v-ripple to="/admin/homepage" style="color: #F2F2F2;">
          ...
          <q-item clickable v-ripple to="/admin/account" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="people" />
            </q-item-section>
          ...
          <!-- <q-expansion-item expand-separator icon="event_available" label="Deparments" style="color: #F2F2F2;">
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> CITE Department </q-item-section>
            </q-item>
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> Marketing Department </q-item-section>
            </q-item>
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> Criminology Department</q-item-section>
            </q-item>
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;">Senior High Department </q-item-section>
            </q-item>
          </q-expansion-item> -->
          <q-item clickable v-ripple to="/admin/history" style="color: #F2F2F2;">
            <q-item-section avatar>
          ...
          <q-item clickable v-ripple to="/admin/backup" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="backup" />
            </q-item-section>
