...
<template>
  <q-page>
    <q-card style="height: 700px; background-color: #f2f2f2;">
      <q-card-section>
        <div class="text-h5 q-ml-sm text-bold" style="margin-top: 12px;">History</div>
      </q-card-section>
...
<script src="pages/instructor-folder/instructor-scripts/InstructorHistory.js"></script>
