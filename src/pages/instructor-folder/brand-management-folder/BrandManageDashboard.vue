<template>
  <q-layout view="hHh Lpr lff" container class="layout-size">
            ...
            <div class="row no-wrap flex">
              <div class="column">
                ...
                <div class="profile-info q-pa-sm">
                  ...
                  <q-list>
                    <q-item clickable v-ripple to="/brand-management-dashboard/BrandManagement-account" class="it-1">
    ...
    <q-drawer class="q-pt-lg" v-model="drawer" show-if-above :mini="!drawer || miniState" @click.capture="drawerClick"
      :width="230" :breakpoint="787" bordered :class="$q.dark.isActive" style="background-color: #182628;">
      <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }">
        <q-list padding>
          <q-item clickable v-ripple to="/brand-management-dashboard/BrandManagement-page" style="color: #F2F2F2;">
          ...
          <q-item clickable v-ripple to="/brand-management-dashboard/BrandManagement-subject" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="people" />
            </q-item-section>

            <q-item-section> Availabilities </q-item-section>
          </q-item>

          <q-item clickable v-ripple to="/brand-management-dashboard/BrandManagement-specialization"
            style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="cast_for_education" />
            </q-item-section>

            <q-item-section> Specializations </q-item-section>
          </q-item>


          <q-expansion-item expand-separator icon="list_alt" label="Week List" style="color: #F2F2F2;">
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> Monday </q-item-section>
            </q-item>
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> Tuesday </q-item-section>
            </q-item>
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> Thursday </q-item-section>
            </q-item>
            <q-item clickable v-ripple to="">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: goldenrod;"> Friday </q-item-section>
            </q-item>
          </q-expansion-item>
          <q-item clickable v-ripple to="/brand-management-dashboard/BrandManagement-history" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="history" />
            </q-item-section>
...
<script src="pages/instructor-folder/instructor-scripts/InstructorPage"></script>

<style lang="scss" scoped>
@import "pages/instructor-folder/instructor-style/InstructorPage.scss";
</style>
