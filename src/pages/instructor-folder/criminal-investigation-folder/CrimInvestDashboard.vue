  ...
  <q-layout view="hHh Lpr lff" container class="layout-size">
            ...
            <div class="row no-wrap flex">
              <div class="column">
                ...
                <div class="profile-info q-pa-sm">
                  ...
                  <q-list>
                    <q-item clickable v-ripple to="/crim-invest-dashboard/CrimInvest-account" class="it-1">
    ...
    <q-drawer v-model="drawer" show-if-above :mini="!drawer || miniState" @click.capture="drawerClick" :width="230"
      ...
      <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }">
        <q-list padding>
          <q-item clickable v-ripple to="/crim-invest-dashboard/CrimInvest-subject" style="color: #F2F2F2;">
          ...
          <q-item clickable v-ripple to="/crim-invest-dashboard/CrimInvest-history" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="history" />
            </q-item-section>
