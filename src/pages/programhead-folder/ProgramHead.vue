  ...
  <q-layout view="hHh Lpr lff" container class="layout-size">
            ...
            <div class="row no-wrap flex">
              <div class="column">
                ...
                <div class="profile-info q-pa-sm">
                  ...
                  <q-list>
                    <q-item clickable v-ripple to="/program-head/information-technology/account" class="it-1">
    ...
    <q-drawer class="q-pt-lg" v-model="drawer" show-if-above :mini="!drawer || miniState" @click.capture="drawerClick"
      ...
      <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }">
        <q-list padding>
          <q-item clickable v-ripple to="/program-head/information-technology" style="color: #F2F2F2;">
          ...
          <q-item clickable v-ripple to="/program-head/information-technology/schedule" style="color: #F2F2F2;">
            <q-item-section avatar>
          ...
          <!-- <q-item clickable v-ripple to="/program-head/information-technology/second-year" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="event_available" />
            </q-item-section>

            <q-item-section> Sample Table </q-item-section>
          </q-item> -->



          <q-expansion-item expand-separator icon="people" label=" Instructors Availability" style="color: #F2F2F2;">
            <q-item clickable v-ripple to="/program-head/information-technology/available">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: #F2F2F2;"> Animation </q-item-section>
            </q-item>
            <q-item clickable v-ripple to="/program-head/information-technology/information-technology">
              <q-item-section avatar> </q-item-section>

              <q-item-section style="color: #F2F2F2; "> IT </q-item-section>
            </q-item>

          </q-expansion-item>
          <q-item clickable v-ripple to="/program-head/information-technology/history" style="color: #F2F2F2;">
            <q-item-section avatar>
              <q-icon name="history" />
            </q-item-section>
...
@import "pages/programhead-folder/programhead-style/ProgramHead-Page.scss";
</style>
